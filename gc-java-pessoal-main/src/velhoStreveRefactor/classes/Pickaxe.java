...
import velhoStreveRefactor.interfaces.Tool;

public class Pickaxe extends AbstractTool implements Tool {
    private int blocks;

    public Pickaxe(String name, int durability, Materials materials, int blocks) {
        super(name, durability, materials);
        this.blocks = blocks;
    }
    ...
    @Override
    public String Make(String material, int durabilidade, int forca) {
        System.out.println("\n=== FABRICANDO PICARETA ===");
    ...
    @Override
    public int Repair(String material, int durabilidadeAtual, int quantidade) {
